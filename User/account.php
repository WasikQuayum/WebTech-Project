  ...
  <head>
	...
	<form action="account.php" method="post">
		<header>
            ...
            <li > 
			<a href="userhome.php" style="color:White"  > Home </a>&nbsp  &nbsp
			<a href="account.php" style="color:Red">Account </a>&nbsp  &nbsp
		...
		<input type="submit" name="psubmit" id="psubmit" value="Change pass"><br><br><br>
			...
			<br>
			<div id="quiz"><b>Your quiz info will be listed here...</b></div>
		</div>
